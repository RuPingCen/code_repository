...
public:
  ...
  ZedCameraROS()
  {
    ...
    private_nh.param("gray_image", gray_image_, false);
                        ...
                        sensor_msgs::CameraInfo& right_info)
  {
    ...
    left_info.width = width_;   // camera_->get(WIDTH_ID),
    right_info.width = width_;  // camera_->get(HEIGHT_ID));
...
private:
  ...
  double frame_rate_;
  bool show_image_, use_zed_config_,gray_image_;
